...
<br>
.center[
### $\Rightarrow$ Biodiversity trends have to be assessed across spatial (and temporal) scales
]
...
* Species richness change is the sum of these 3 processes
...
$jaccard = \frac{pers}{pers+col+ext}$
...
$betasim = \frac{min(ext,col)}{pers + min(ext,col)}$
